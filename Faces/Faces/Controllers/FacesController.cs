...
namespace FacesApi.Controllers
{
    ...
    public class FacesController : ControllerBase
    {
        ...
        {
            // Convert the byte array into jpeg image and Save the image coming from the source in the root directory for testing purposes. 
            var subKey = Configuration.AzureSubscriptionKey;
            var endPoint = Configuration.AzureEndPoint;
        ...
        //    {
        //        var faceImage = new Mat(src, rectangle);
